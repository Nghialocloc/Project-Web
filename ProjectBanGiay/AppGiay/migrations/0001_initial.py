    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenchucvu', models.CharField(db_column='TenChucVu', max_length=100)),
                ('quyenhan', models.SmallIntegerField(db_column='QuyenHan', db_comment='Quyền hạn người dùng : nhân viên=1, quản lí=2')),
            ],
            options={
                'db_table': 'role',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usename', models.CharField(db_column='Usename', max_length=30)),
                ('password', models.CharField(db_column='Password', max_length=30)),
