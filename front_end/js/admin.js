...
window.onload = function () {
    ...
    if (window.localStorage.getItem('admin','nhân viên')) {
        addTableProducts();
        addTableDonHang();
        addTableKhachHang();
        addThongKe();
...
function layThongTinSanPhamTuTable(id) {
    ...
    var chatlieu = tr[12].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var mau = tr[13].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var nsx = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function addKhungSuaSanPham(masp) {
    ...
    s += `
        ...
        <tr>
            <td>Chất liệu:</td>
            <td><input type="text" value="`+sp.detail.chatlieu+`"></td>
        </tr>
        <tr>
            <td>Mẫu:</td>
            <td><input type="text" value="`+sp.detail.mau+`"></td>
        </tr>
        <tr>
            <td>Năm sản xuất:</td>
            <td><input type="text" value="`+sp.detail.nsx+`"></td>
        </tr>
        <tr>
            <td>Màu:</td>
